...
export default class Home extends Component {
  ...
  render(){
    ...
    <h2>"No personal calamity is so crushing that something true and great can’t be made of it."</h2>
    <h4>-Bill W. Founder of Alcoholic Anonymous</h4>
  </div>
  </div>
  <div id="homeDiv2opacity" style={{display: this.state.div2Display}}>
      <div className="homeDiv2">
        <h2> Welcome to The Next Step! Your online resource for addiction and substance abuse.</h2>
    </div>
  </div>
  <div id="homeDiv3opacity" style={{display: this.state.div3Display}}>
      <div className="homeDiv3">
        <h2>Whether you are on step twelve or trying to reach step one, the next step is a step forward.</h2>
    ...
    <div className="homeDescription" style={{display: this.state.description}}>
        <h1>To see all available sponsors in your area, please sign in under the sponsee tab.</h1>
        <h1>If you're looking for a chance to sponsor someone, please sign in under the sponsor tab.</h1>
        <h1>You don't have to have to sign in to find facilities near you. All you have to do is click the facilities tab in the navbar.</h1>
          {/* <p class="madeFooter">made with <i class="red heart icon" size="large"></i>by <a className="madeByAnchor" href="https://macro6461.github.io/">&copy;Matthew Croak Media 2017</a></p> */}
        </div>
      </div>
    )
